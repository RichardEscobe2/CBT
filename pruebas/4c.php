...
<nav class="navbar d-flex justify-content-between align-items-center px-4 py-2">
  <img src="https://via.placeholder.com/50x50" alt="Izq">
  <h4 class="m-0 text-danger fw-bold">EDUCACIÓN</h4>
  <img src="https://via.placeholder.com/50x50" alt="Der">
</nav>
  ...
  <div class="row justify-content-center g-4">
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        <div class="card-img-sim"></div>
        <div class="card-body text-center">
          <h5 class="card-title">Constancia de Termino Servicio Social</h5>
