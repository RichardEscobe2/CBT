...
<head>
  ...
  <title>5 Cards Distribuidas</title>
  ...
  <div class="row justify-content-evenly g-3">
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg">
      <div class="card h-100">
        <div class="card-img-sim"></div>
        <div class="card-body text-center">
          <h5 class="card-title">Solicitud Elaboracion de Practicas Profesionales</h5>
          <p>Documentación adicional del plantel.</p>
          <button class="btn btn-wine w-100" data-bs-toggle="modal" data-bs-target="#modal5">Realizar trámite</button>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="modal5" tabindex="-1"><div class="modal-dialog"><div class="modal-content p-5">Modal 5</div></div></div>
